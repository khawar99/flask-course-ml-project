...
def predict():
    ...
    if form.validate_on_submit():
        ...
        x_new = pd.DataFrame(dict(
            ...
            date_of_journey=[form.date_of_joining.data.strftime("%Y-%m-%d")],  # Corrected to match your dataset
        ...
        # Print the DataFrame to check for correct columns
        print(x_new)

        # Make prediction
        prediction = model.predict(x_new)[0]
        message = f"The predicted price is {prediction:,.0f}."
    else:
